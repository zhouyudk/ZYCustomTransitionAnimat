...
class ZYPresentAsOpenAnimation: ZYAnimation {
    ...
    override func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        //用于动画
        var targetRect0 = CGRect(x: 0, y: -screenHeight/2, width: screenWidth, height: screenHeight)
        var targetRect1 = CGRect(x: 0, y: screenHeight/2, width: screenWidth, height: screenHeight)
        switch direction {
        case .horizontal:
            ...
            targetRect0 = CGRect(x: -screenWidth/2, y: 0, width: screenWidth, height: screenHeight)
            targetRect1 = CGRect(x: screenWidth/2, y: 0, width: screenWidth, height: screenHeight)
        case .vertical:
            ...
            targetRect0 = CGRect(x: 0, y: -screenHeight/2, width: screenWidth, height: screenHeight)
            targetRect1 = CGRect(x: 0, y: screenHeight/2, width: screenWidth, height: screenHeight)
        }
        let tmpImage0 = fromView.zy_snapshot(rect: rect0)
        let tmpImage1 = fromView.zy_snapshot(rect: rect1)
